...
public class UserInterface {
	...
	public static int askForSetup(String msg) {
		while (!(msg == null) && !(msg.matches("[0-9]+"))) { // Kollar om man klickar i nått annat än siffror. ( "" eller Cancel )
			  
			JOptionPane.showMessageDialog(null, "Du måste välja ett positivt heltal", "ErRor", JOptionPane.ERROR_MESSAGE );
		 msg = JOptionPane.showInputDialog("Välj ett postitivt heltal");
